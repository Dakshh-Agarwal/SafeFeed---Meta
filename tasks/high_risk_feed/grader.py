"""
Grader for the high_risk_feed task (medium difficulty).
...
def grade(*args, **kwargs):
    ...
    try:
        ...
        print(f"[GRADER] high_risk_feed grade error: {e}", file=sys.stderr)
        return 0.5
...
def _run_and_grade(task_config):
    try:
        ...
        print(f"[GRADER] high_risk_feed fallback error: {e}", file=sys.stderr)
        return 0.5
