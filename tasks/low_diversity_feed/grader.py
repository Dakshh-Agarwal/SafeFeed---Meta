"""
Grader for the low_diversity_feed task (hard difficulty).
...
def grade(*args, **kwargs):
    ...
    try:
        ...
        print(f"[GRADER] low_diversity_feed grade error: {e}", file=sys.stderr)
        return 0.5
...
def _run_and_grade(task_config):
    try:
        ...
        print(f"[GRADER] low_diversity_feed fallback error: {e}", file=sys.stderr)
        return 0.5
